...
import { Place, SiteConfig, BlogPost, DownloadItem, Designer, Notification } from './types';
...
export const DISTRICTS: Record<string, string[]> = {
  ...
  "Assam": ["Baksa", "Barpeta", "Biswanath", "Bongaigaon", "Cachar", "Charaideo", "Chirang", "Darrang", "Dhemaji", "Dhubri", "Dibrugarh", "Dima Hasao", "Goalpara", "Golaghat", "Hailakandi", "Hojai", "Jorhat", "Kamrup Metropolitan", "Kamrup", "Karbi Anglong", "Karimganj", "Kokrajhar", "Lakhimpur", "Majuli", "Morigaon", "Nagaon", "Nalbari", "West Karbi Anglong", "Sivasagar", "Sonitpur", "South Salmara-Mankachar", "Tinsukia", "Udalguri"],
  ...
  "Karnataka": ["Bagalkot", "Bangalore Rural", "Bangalore Urban", "Belgaum", "Bellary", "Bidar", "Chamarajanagar", "Chikkaballapur", "Chikkamagaluru", "Chitradurga", "Dakshina Kannada", "Davangere", "Dharwad", "Gadag", "Gulbarga", "Hassan", "Haveri", "Kodagu", "Kolar", "Koppal", "Mandya", "Mysore", "Raichur", "Ramanagara", "Shimoga", "Tumkur", "Udupi", "Uttara Kannada", "Vijayapura", "Yadgir"],
...
export const CONFIG_DEFAULTS: SiteConfig = {
  siteName: "خريطة السُّنّة – الهند",
  adminEmail: "admin@masjidatlas.in",
  states: Object.keys(DISTRICTS).sort(), // Dynamically load all states
  contactEmail: "hello@masjidatlas.in",
  contactLocation: "Bangalore, India",
  contactPhone: "+91 9876543210",
  footerText: "Connecting the Ummah across India.",
  partners: [],
  partnerLayout: 'MARQUEE'
};
